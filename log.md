...
**Today's Progress**: I create a Reddit clone project then I designed the database structure and migrate it using bufallo/fizz library

**Thoughts:** I really struggled with fiz library. Mostly because the library is very limited when it comes to making constraints and concatenations in PgSQL
